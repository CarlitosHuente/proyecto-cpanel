...
CATALOGO: List[dict] = [
    ...
    },
    {
        ...
        "hijos": [
            {"id": "buk.nomina", "label": "Nómina vigente", "desc": "Listado colaboradores activos."},
            {"id": "buk.asistencia", "label": "Asistencia hoy", "desc": "Marcajes del día vs nómina."},
            {"id": "buk.ausencias", "label": "Ausencias mes", "desc": "Días sin marca en el mes."},
            {"id": "buk.calendario", "label": "Calendario mensual", "desc": "Turnos, marcajes y horas netas por trabajador."},
            {"id": "buk.alertas", "label": "Alertas", "desc": "Campanita: sin turno, sin marca, atrasos."},
            {"id": "buk.encuestas", "label": "Encuestas", "desc": "PDF capacitación → Buk."},
        ],
    },
    {
        "id": "flujo",
...
PAGINAS_INICIO: List[dict] = [
    ...
    {"endpoint": "buk.calendario", "label": "Buk — Calendario mensual"},
    {"endpoint": "buk.alertas", "label": "Buk — Alertas"},
